...
private class Node(var time: Int, var direction: Char)
private class Position(var x: Int, var y: Int)

private var n = 0
private var k = 0
private var l = 0
private var array = Array(101) { IntArray(101) }//맵 정보
private var info = ArrayDeque<Node>()//방향 회전 정보

//처음에는 오른쪽을 보고 있으므로(동, 남, 서, 북)
private val dx = intArrayOf(0, 1, 0, -1)
private val dy = intArrayOf(1, 0, -1, 0)
private fun turn(direction: Int, c: Char): Int {
